...
const ForInvestor = () => {
  ...
  return (
    <SForInvestor>
      <Row>
        <Col xl={14}>
          <div className="wrap-for-investor p-auto">
            ...
            <div className="find-companies">
              ...
              <span className="content">
                Search and filter and more to seek for our vetted companies in
                many industries
              </span>
            </div>
        ...
        <Col xl={2} />
        <Col xl={8}>
          <div className="wrap-for-investor img-investor-banner">
            <img
              alt="banner-for-investor"
              src="/image/home/home-for-investor.png"
            />
          </div>
        </Col>
      </Row>
